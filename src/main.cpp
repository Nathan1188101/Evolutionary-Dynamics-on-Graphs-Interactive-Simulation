...
int main() {     
    ...
    controlButtonRenderer->setBackgroundColorHover(tgui::Color(40, 40, 50));
    controlButtonRenderer->setBackgroundColorDown(tgui::Color(20, 20, 25));
    controlButtonRenderer->setBorderColor(tgui::Color(60, 60, 70)); 
    controlButtonRenderer->setBorderColorHover(tgui::Color(80, 80, 100));
    controlButtonRenderer->setBorderColorDown(tgui::Color(80, 80, 100));
    controlButtonRenderer->setTextColor(tgui::Color::White); 
    controlButtonRenderer->setTextColorHover(tgui::Color::White); 
